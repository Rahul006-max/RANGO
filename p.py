...
idx2 = text.find('    <div className={claudeShell', idx1)
# Backtrack idx2 to the preceding 'return ('
idx2 = text.rfind('return (', idx1, idx2)
...
if idx1 != -1 and idx2 != -1:
    ...
    with open('frontend/src/App.jsx', 'w', encoding='utf-8', newline='\n') as f:
        f.write(new_text)
    print('Repatched properly')
else:
    print('Indexes not found:', idx1, idx2)
