      ...
      <div className="authGate">
        <div className="authCard">
          <div className="authLogo">
            <Sparkles size={32} /> RAG Optimizer
          </div>
          <div className="authSubtitle">
            Compare retrieval pipelines, optimize your RAG stack, and analyze
            documents with AI.
          </div>
          <button className="btn primary authBtn" onClick={signInWithGoogle}>
            <LogIn size={18} style={{ marginRight: 8 }} /> Sign in with Google
          </button>
        </div>
        <Toaster
          position="top-right"
